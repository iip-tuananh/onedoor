        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <!-- <div class="form-group">
                <label>Link sang sản phẩm khác</label>
                <i style="color:red">*Cụm đầu tiên để sản phẩm hiện tại</i>
                  ...
                  <div class="row">
                    <div class="col-11">
                      ...
                      <vs-input
                        ...
                        class="w-100"
                        v-model="objData.ingredient[index].detail"
                      />
                      <br />
                    </div>
                    <div class="col-1">
    ...
    editById() {
      ...
      this.editId({id:this.$route.params.id}).then(response => {
        this.loadings(false);
          ...
          if(response.data.ingredient == "" || response.data.ingredient == null){
