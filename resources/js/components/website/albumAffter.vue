<template>
  <div>
      <h3 class="page-title">Quản lý chứng nhận và video</h3>
      <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body" >
                ...
                <div class="col-md-9">
                  ...
                  <div class="form-group">
                    ...
                    <vs-input
                      ...
                      v-model="item.link"
                      size="default"
                      placeholder="Link liên kết (bỏ trống đối với ảnh)"
                      class="w-100"
                    />
                  </div>
                  <div class="form-group">
                  ...
                  >
                      <vs-select-item  value="1" text="Ảnh" />
                      <vs-select-item  value="0" text="Video" />
                    </vs-select>
                  </div>
                </div>
              ...
              <vs-button color="success" @click="addObjPartner">Thêm ảnh/video</vs-button>
            </div>
          </div>
        </div>
      </div>
