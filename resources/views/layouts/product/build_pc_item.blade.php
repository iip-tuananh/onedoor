    ...
    <div class="row">
       ...
       <div class="col-6 p-0">
          <div class="css-pbiq9j">
             <div>
                <a target="_blank" href="{{route('detailProduct',['cate'=>$item['cate_slug'],'type'=>$item['type_slug'] ?? 'loai','id'=>$item['slug']])}}" rel="noreferrer noopener" target="_blank" class="css-587jha">
